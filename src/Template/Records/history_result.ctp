...
<section class="content-header apal-page" data-sidebar="challenges">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Historial del Resultado</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <li class="breadcrumb-item"><?= $this->Html->link(__('Desafíos'), ['controller' => 'Challenges', 'action' => 'index'], ['escape'=>false]) ?></li>
          <li class="breadcrumb-item"><?= $this->Html->link(__('Resultados'), ['controller' => 'Results', 'action' => 'index', $result->challenge_id], ['escape'=>false]) ?></li>
          <li class="breadcrumb-item active">Historial del Resultado</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        Historial del Resultado: <?= $result->challenge->name.': '. $result->player->firstname.' '.$result->player->lastname ?>
                    </h3>
                ...
                <div class="card-footer">
                    ...
                    <?= $this->Html->link(__('<i class="fas fa-angle-left"></i> Regresar'), ['controller' => 'Results' , 'action' => 'index', $result->challenge_id], ['class' => 'btn btn-secondary mt-2', 'escape' => false]) ?>
                </div>
            </div>
        </div>
    </div>
