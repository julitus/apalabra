        ...
        <div class="col-md-12">
            <div class="card card-info card-outline">
              ...
              <div class="card-header">
                <h3 class="card-title">Modificar Creador: <?= $user->username ?></h3>
              </div>
              ...
              <?= $this->Form->create($user) ?>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <?= $this->Form->control('email', ['class' => 'form-control', 'label' => 'Correo Electrónico']) ?>
                  </div>
                  <div class="form-group">
                    <?= $this->Form->control('phone', ['class' => 'form-control', 'label' => 'Teléfono / Celular']) ?>
                  </div>
                </div>
