...
class ChallengesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'code' => ['type' => 'string', 'length' => 32, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'challenges_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'attemps' => 1,
                'active' => 1,
                'created' => '2021-02-15 19:02:58',
                'modified' => '2021-02-15 19:02:58',
            ],
        ];
        parent::init();
    }
